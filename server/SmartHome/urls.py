...
urlpatterns = [
    ...
    url(r'^api/users/(?P<user_id>[0-9]+|me)/homes/$', views.HomeListByUser.as_view()),
    #url(r'^api/users/(?P<pk>[0-9]+|me)/friend_requests/sent/$', None),
    #url(r'^api/users/(?P<pk>[0-9]+|me)/friend_requests/received/$', None),
    url(r'^api/users/(?P<user_id>[0-9]+|me)/posts/$', views.PostsList.as_view()),
    url(r'^api/users/(?P<user_id>[0-9]+|me)/friends/$', views.FriendsList.as_view()),
    #url(r'^api/users/(?P<pk>[0-9]+|me)/friends/posts/$', None),
    #url(r'^api/users/(?P<pk>[0-9]+|me)/data/(?P<period>today|last_month|last_year|past_years)/$', None),
    ...
    #url(r'^api/homes/(?P<pk>[0-9]+)/sensors/$', None),
    #url(r'^api/homes/(?P<pk>[0-9]+)/data/(?P<period>today|last_month|last_year|past_years)/$', None),
    url(r'^api/sensors/$', views.SensorList.as_view()),
    url(r'^api/sensors/(?P<pk>[0-9]+)/$', views.SensorDetail.as_view()),
    #url(r'^api/sensors/(?P<pk>[0-9]+)/data(?P<period>today|last_month|last_year|past_years)/$', None),
