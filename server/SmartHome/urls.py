...
urlpatterns = [
    ...
    url(r'^api/users/(?P<pk>[0-9]+|me)/homes/$', views.HomeListByUser.as_view()),
    #url(r'^api/users/(?P<pk>[0-9]+|me)/friend_requests/sent/$', None),
    #url(r'^api/users/(?P<pk>[0-9]+|me)/friend_requests/received/$', None),
    url(r'^api/users/(?P<pk>[0-9]+|me)/posts/$', views.PostsList.as_view()),
    url(r'^api/users/(?P<pk>[0-9]+|me)/friends/$', views.FriendsList.as_view()),
